...
const PROGRAMS: &[(&str, ProgramKind)] = &[
    ...
    ("trace_sys_exit_openat",         ProgramKind::Tracepoint { category: "syscalls", name: "sys_exit_openat" }),
    ("trace_sys_enter_open",          ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_open" }),
    ("trace_sys_exit_open",           ProgramKind::Tracepoint { category: "syscalls", name: "sys_exit_open" }),
    ...
    ("trace_sys_enter_access",        ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_access" }),
    ("trace_sys_enter_lseek",         ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_lseek" }),
    ("trace_sys_enter_fcntl",         ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_fcntl" }),
    ("trace_sys_enter_ioctl",         ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_ioctl" }),
    ("trace_sys_enter_socket",        ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_socket" }),
    ("trace_sys_enter_setsockopt",    ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_setsockopt" }),
    ("trace_sys_enter_getsockopt",    ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_getsockopt" }),
    ("trace_sys_enter_pipe",          ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_pipe" }),
    ("trace_sys_enter_pipe2",         ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_pipe2" }),
    ("trace_sys_enter_getpid",        ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_getpid" }),
    ("trace_sys_enter_getuid",        ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_getuid" }),
    ("trace_sys_enter_newuname",      ProgramKind::Tracepoint { category: "syscalls", name: "sys_enter_newuname" }),
    ...
    ("trace_vfs_readv_ret",           ProgramKind::Kretprobe { fn_name: "vfs_readv" }),
    ("trace_vfs_writev_ret",          ProgramKind::Kretprobe { fn_name: "vfs_writev" }),
    ("trace_copy_file_range_ret",     ProgramKind::Kretprobe { fn_name: "copy_file_range" }),
